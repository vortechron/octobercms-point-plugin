...
return [
    'plugin' => [
        'name' => 'Point System',
        'description' => 'Provide point based system to your post.'
    ],
    'event' => [
        'menu_label' => 'Event',
        'menu_description' => 'Manage Event Posts',
        'posts' => 'Posts',
        'create_post' => 'Event post',
        'categories' => 'Categories',
        'create_category' => 'Event category',
        'tab' => 'Event',
        'access_posts' => 'Manage the event posts',
        'access_categories' => 'Manage the event categories',
        'access_other_posts' => 'Manage other users event posts',
        'access_import_export' => 'Allowed to import and export posts',
        'access_publish' => 'Allowed to publish posts',
        'manage_settings' => 'Manage event settings',
        'delete_confirm' => 'Are you sure?',
        'chart_published' => 'Published',
        'chart_drafts' => 'Drafts',
        'chart_total' => 'Total',
        'settings_description' => 'Manage event settings',
    ...
    'posts' => [
        'list_title' => 'Manage the event posts',
    ...
    'post' => [
        ...
        'categories_comment' => 'Select categories the event post belongs to',
    ...
    'categories' => [
        'list_title' => 'Manage the event categories',
    ...
    'category' => [
        ...
        'return_to_categories' => 'Return to the event category list',
        'reorder' => 'Reorder Categories'
    ],
    'menuitem' => [
        'event_category' => 'Event category',
        'all_event_categories' => 'All event categories',
        'event_post' => 'Event post',
        'all_event_posts' => 'All event posts',
        'category_event_posts' => 'Event category posts'
    ],
    'settings' => [
        'category_title' => 'Category List',
        'category_description' => 'Displays a list of event categories on the page.',
        'category_slug' => 'Category slug',
        'category_slug_description' => "Look up the event category using the supplied slug value. This property is used by the default component partial for marking the currently active category.",
        ...
        'post_title' => 'Post',
        'post_description' => 'Displays a event post on the page.',
        'post_slug' => 'Post slug',
        'post_slug_description' => "Look up the event post using the supplied slug value.",
        ...
        'posts_description' => 'Displays a list of latest event posts on the page.',
        ...
        'posts_no_posts_description' => 'Message to display in the event post list in case if there are no posts. This property is used by the default component partial.',
        ...
        'posts_post_description' => 'Name of the event post page file for the "Learn more" links. This property is used by the default component partial.',
        ...
        'rssfeed_event' => 'Event page',
        'rssfeed_event_description' => 'Name of the main event page file for generating links. This property is used by the default component partial.',
        'rssfeed_title' => 'RSS Feed',
        'rssfeed_description' => 'Generates an RSS feed containing posts from the event.',
        'group_links' => 'Links',
